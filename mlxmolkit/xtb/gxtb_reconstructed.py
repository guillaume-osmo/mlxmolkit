...
def gxtb_reconstructed_repulsion(
    ...
    *,
    ...
    # contraction.  The asm kernel differentiates the explicit r-dependence
    # only, so this term was absent -- not wrong, absent -- and the gradient
    # was 1.9e-2 to 3.1e-2 Ha/Bohr off the binary's (walk stage 25a).  Adding
    # it closes 25a to 1.1e-16 / 3.4e-16 / 5.6e-17.
    #
