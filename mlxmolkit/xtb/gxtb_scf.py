...
def _install_onecxints() -> bool:
    """Load the packaged one-centre data, failing if it is unavailable.

    Silently returning False here drops onsite exchange from the model.
    The shared lazy loader provides the same table in checkouts and wheels.
    """
