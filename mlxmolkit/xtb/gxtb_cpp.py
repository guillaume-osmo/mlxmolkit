...
NATIVE_KERNELS: tuple[GXTBSymbolKernel, ...] = (
    GXTBSymbolKernel(
...
def native_kernel_status() -> tuple[GXTBSymbolKernel, ...]:
    """Return the model routines that have a native callable wrapper."""
...
def repulsion_state(
    ...
    """Apply the g-xTB repulsion scaling/update formulas to one system."""
